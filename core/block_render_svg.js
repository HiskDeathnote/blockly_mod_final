 ...
 * @const
 */
// The TODOs in the document are for highlighting notes of the programming block below them


// TODO: Custom UI Constants
Blockly.BlockSvg.MOD_SPACER_PATH = 'M 0 0 L -10 5 L -30 5 L -30 45 L -10 45 L 0 38 L 0 0';;
var height_of_block = 0;

// End of Custom Contants


 // TODO: X Spacing between elements 
Blockly.BlockSvg.SEP_SPACE_X = 35;
/**
 * Vertical space between elements.
 * @const
 */
// TODO: Y Spacing between elements
 ...
 * @const
 */
// TODO: Width of the tab (value input jagged teeth)
Blockly.BlockSvg.TAB_WIDTH = 0;
/**
 * Width of vertical tab (inc left margin).
 * @const
 */
// TODO: The variable below can change the point where the notch starts
Blockly.BlockSvg.NOTCH_WIDTH = 30;
/**
 * Rounded corner radius.
 * @const
 */
// TODO: Radius of the corner
 ...
 * @const
 */
// TODO: Drawing Notch, initially '1 6, 4 3, 0 6, -4'
 ...
 * @const
 */
// TODO: Drawing Notch highlighting, initially '1 6, 4 3, 0 6, -4'
Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT = '0 0,0 0,0 0, 0';
/**
 * SVG path for drawing next/previous notch from right to left.
 * @const
 */
// TODO: Drawing Notch Right, initially 'l -6,4 -3,0 -6,-4'
Blockly.BlockSvg.NOTCH_PATH_RIGHT = 'l -6,10 -3,0 -6, 0';
/**
 ...
 * @const
 */
// TODO: Path for tabs (value input jagged teeth)
 ...
 * @const
 */
// TODO: Start point for the actual block
 ...
 * @const
 */
// TODO: Start point for actual highlight
 ...
 * @const
 */
// TODO: Change the shape of the rounded top-left corner here
// You can insert an svg code directly here
// TODO: !!! Make this path update dynamically, add the width and height of the block !!!
Blockly.BlockSvg.TOP_LEFT_CORNER = 
    // 'M 0 0 L -10 5 L -30 5 L -30 45 L -10 45 L 0 38 L 0 0';
    // TODO: Added MOD_SPACER_PATH to original path
    Blockly.BlockSvg.MOD_SPACER_PATH +
 ...
 * @const
 */
// TODO: Change the highlighting shape of the rounded top-left corner here
// You can insert an svg code directly here
 ...
 * @const
 */
// TODO: This block draws the notch, horizontal space and rounded inside corner of statement input
 ...
 * @const
 */
// TODO: This block draws highlighting of the notch, horizontal space and rounded inside corner of statement input
 ...
 * @const
 */
// TODO: Highlight bottom left corner of the statement input
...
Blockly.BlockSvg.prototype.render = function(opt_bubble) {
  ...
  // TODO: initially cursorX = Blockly.BlockSvg.SEP_SPACE_X but now zero to remove the initial spacing when building blocks
  var cursorX = 10;
  if (this.RTL) {
    cursorX = -cursorX;
  }
...
Blockly.BlockSvg.prototype.renderDraw_ = function(iconWidth, inputRows) {
  ...
  // TODO: Blocks are created below, all functions are called here
  var highlightSteps = [];
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(steps, highlightSteps,
  ...
  for (var y = 0, row; row = inputRows[y]; y++) {
    ...
    if (this.isCollapsed()) {
      ...
      // TODO: Inline inputs are drawn here
...
Blockly.BlockSvg.prototype.renderDrawBottom_ =
  ...
  if (this.nextConnection) {
    // TODO: Removed bottom notch from steps.push, initial code was
 ...
 * @private
 */
// TODO: Rendering the left edge here, add the required block to reuqired elements (move, turn, repeat and if) here
Blockly.BlockSvg.prototype.renderDrawLeft_ =
  ...
  if (this.outputConnection) {
    ...
    if (this.squareTopLeftCorner_) {
      ...
      // TODO: Modified this line, original didn't contain MOD_SPACER_PATH 
      highlightSteps.push('V', Blockly.BlockSvg.CORNER_RADIUS, Blockly.BlockSvg.MOD_SPACER_PATH);
    }
  }
  steps.push('z');
};  /* eslint-enable indent */